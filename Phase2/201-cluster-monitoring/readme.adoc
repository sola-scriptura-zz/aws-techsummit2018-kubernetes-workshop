...
Install a Java application as explained in link:../../Phase3/306-app-management-with-helm[Deploying applications using Kubernetes Helm charts].
...
Heapster, InfluxDB and Grafana are http://kubernetes.io/docs/admin/addons/[Kubernetes addons]. You can download the file relative this session instruction right here - link:https://raw.githubusercontent.com/cristov/aws-techsummit2018-kubernetes-workshop/master/Phase2/201-cluster-monitoring/templates/[template-files, window="blank"]
...
>|Next image:go-next.png[alt="go Next",link=../202-service-mesh,width=50]
