...
[cols="1,1",width="90%"]
|=====
<|image:go-back.png[alt="go Back",link=../204-cluster-logging-with-EFK,width=50] Back
>|Next image:go-next.png[alt="go Next",link=../206-cloudformation-and-terraform,width=50]
