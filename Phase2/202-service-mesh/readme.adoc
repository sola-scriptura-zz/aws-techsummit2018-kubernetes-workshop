...
[align="right", cols="1", grid="none", frame="none"]
|=====
|image:go-back.png[alt="go Next",link=../201-cluster-upgrades,width=50] |image:go-next.png[alt="go Next",link=../203-cluster-upgrades,width=50]
|link:../readme.adoc[Go to Phase2 Index]
|=====