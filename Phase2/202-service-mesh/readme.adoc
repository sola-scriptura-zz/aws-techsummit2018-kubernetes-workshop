...
[align="right", cols="2", grid="none", frame="none", width="100%"]
|=====
|
[caption="go Back",link=../201-cluster-upgrades] image:go-back.png[width=50]
|
[caption="go Next",link=http://github.com/cristov/aws-techsummit2018-kubernetes-workshopPhase2/203-cluster-upgrades] image:go-next.png[width=50] 
