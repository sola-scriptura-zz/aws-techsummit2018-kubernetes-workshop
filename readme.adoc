...
|=====
|anchor:k8s-prelab[Pre-Lab - Technical Fundamental Hardning]Build and Deploy Container as MSA
|link:./000-package-manager[200: Kubernetes Package Manager]
|=====
:toc:
== Pre-Lab1 - Technical Fundamental Hardning - 
...
Now you are ready for the start the labs. Go next Phase1.

link:./Phase1/readme.adoc[Go Phase1 - Kubernetes Operation]