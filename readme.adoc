...
== Read firsst : Description of the overall hands-on lab structure and objectives
...
== Pre-Lab0 - Build Structuring a basic environment for operation and management of docker orchestration environment (Cloud9)
