...
You are now ready to continue on with the workshop! Go for Pre-Lab to ensure the container fundermantal technical stack. Let's start Prelab image:go-next.png[alt="go Next",link=./Prelab/readme.adoc,width=50]