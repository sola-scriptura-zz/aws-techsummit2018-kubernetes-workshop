...
== Pre-Lab0 - Read firsst : Description of the overall hands-on lab structure and objectives
...
The next step is link:./Phase1[Technical Fundamental Hardning - Build and Deploy Container as MSA].
