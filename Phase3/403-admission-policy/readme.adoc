...
[cols="1,1",width="90%"]
|=====
<|image:go-back.png[alt="go Back",link=../402-authentication-and-authorization,width=50] Back
>|Next image:go-next.png[alt="go Next",link=../404-network-policies,width=50]
