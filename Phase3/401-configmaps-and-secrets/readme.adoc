...
[cols="1,1",width="90%"]
|=====
<|image:go-back.png[alt="go Back",link=../310-chaos-engineering,width=50] Back
>|Next image:go-next.png[alt="go Next",link=../402-authentication-and-authorization,width=50]
